    ...
    return(
        <nav className="bg-black opacity-50 transition-opacity duration-500 h-[75px] fixed right-0 left-0 top-0 z-50">
            ...
            <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <button type="button" className="text-white border-2 border-main hover:bg-main duration-500 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-4 py-2 text-center">Get started</button>
